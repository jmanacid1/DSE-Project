...
Main data source: Quarterly financial statements, including balance sheets and income statements, from Q1 2000 to Q2 2025 from the National Information Center, a repository maintained by the Federal Reserve that consolidates reporting data from financial institutions operating in the United States. Data can be found at:  
...
The *Paper* and *Presentation* folders contain additional material used for the final project report and presentation.

The *MergesAndAcquisition* folder contains information about mergers and acquisitions collected from our main data source, although this material was not used in the analyses.
